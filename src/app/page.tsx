    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:py-28">
          <div>
            <p className="eyebrow animate-float-in text-base" style={{ animationDelay: "0.05s" }}>
            ...
            >
              ...
              designed around the person you're remembering and the season ahead.
            </p>
            <div
          ...
          {/* Hero ornament — swaying wreath emblem (logo-friendly placeholder) */}
          <div className="relative mx-auto grid h-80 w-80 place-items-center sm:h-96 sm:w-96">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-rose/25 via-cream-deep to-sage/25" />
            <div className="animate-sway grid h-64 w-64 place-items-center rounded-full border-[6px] border-dashed border-sage/50 bg-cream/60 sm:h-72 sm:w-72">
      ...
      <section className="mx-auto max-w-5xl px-5 py-20">
        <div className="grid items-center gap-10 rounded-[2.5rem] border border-line bg-gradient-to-br from-cream to-cream-deep p-8 sm:p-12 md:grid-cols-[0.8fr_1.2fr]">
